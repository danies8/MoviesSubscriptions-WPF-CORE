...
namespace MoviesSubscriptions.UI.ViewModel
{
    public class UsersViewModel : TabViewModelBase
    {
        ...
        private IDetailViewModel _selectedDetailViewModel;
         ...
         public UsersViewModel(IIndex<string, IDetailViewModel> detailViewModelCreator, 
            ...
            IIndex<string, INavigationViewModel> navigationViewModels)
        {
            ...
            _messageDialogService = messageDialogService;
             ...
             SearchUserCommand = new DelegateCommand<string>(OnSearchUserExecute);
        ...
        {
            NavigationViewModel = NavigationViewModels[typeof(UserNavigationViewModel).Name];
        ...
        public override string Title => Constants.UserManagements;
